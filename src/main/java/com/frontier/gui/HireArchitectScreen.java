...
public class HireArchitectScreen extends Screen
{
    ...
    protected void init() 
    {
        ...
        tip1Text = ((MutableText) Text.literal("* Rename settlers with nametags"));
        tip2Text = ((MutableText) Text.literal("* Right-click settlers for options"));
        tip3Text = ((MutableText) Text.literal("* Townhall is the architect's home"));
        tip4Text = ((MutableText) Text.literal("* One architect per settlement"));
