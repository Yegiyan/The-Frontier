...
public class SettlerName
{
	...
	public static String generateLastName()
	{
		...
		String[] selectedSuffixes;

		int culture = random.nextInt(4);
		switch (culture)
		{
		case 0:
			selectedPrefixes = MEDIEVAL_PREFIXES;
			selectedSuffixes = MEDIEVAL_SUFFIXES;
			break;
		case 1:
			selectedPrefixes = CELTIC_PREFIXES;
			selectedSuffixes = CELTIC_SUFFIXES;
			break;
		case 2:
			selectedPrefixes = SLAVIC_PREFIXES;
			selectedSuffixes = SLAVIC_SUFFIXES;
			break;
		case 3:
			selectedPrefixes = GERMANIC_PREFIXES;
			selectedSuffixes = GERMANIC_SUFFIXES;
			break;
		default:
			selectedPrefixes = MEDIEVAL_PREFIXES;
			selectedSuffixes = MEDIEVAL_SUFFIXES;
		...
		String prefix = selectedPrefixes[random.nextInt(selectedPrefixes.length)];
		String suffix = selectedSuffixes[random.nextInt(selectedSuffixes.length)];
